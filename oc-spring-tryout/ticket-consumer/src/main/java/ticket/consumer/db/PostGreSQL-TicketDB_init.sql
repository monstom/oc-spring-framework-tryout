...
INSERT INTO Project (title,creationDate,closed,manager) VALUES 
					...
					('Developpement puce intra_cérébrale','2016-09-10 21:00:00',FALSE,2),
					...
					('Developpement webapp de suivi de projet','2022-03-25 14:53:37',FALSE,5);
...
CREATE INDEX IF NOT EXISTS versionLabel_idx ON Version(label ASC);
...
CREATE TABLE IF NOT EXISTS BugVersionAssociation (
	...
	CONSTRAINT BugVersionAssoFK_bugID
		FOREIGN KEY (Bug_id) REFERENCES Bug(ticket_id)
			ON DELETE CASCADE,
	CONSTRAINT BugVersionAssoFK_versionIDs
